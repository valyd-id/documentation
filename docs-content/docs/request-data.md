> Source: https://{{DOCS_BASE_URL}}/docs/request-data
> Part of: Valyd Developer documentation — static copy generated for AI agents
> Generated from repo component: RequestDataSection.tsx

# Request user data (consent)

## Agent Quick-Start
- Source URL: https://{{DOCS_BASE_URL}}/docs/request-data
...
curl "https://{{IDP_BASE_URL}}/api/auth/attribute-request/$ATTR_CODE/result?client_id=$VALYD_CLIENT_ID"
