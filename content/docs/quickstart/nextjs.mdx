---
title: Next.js (App Router) quickstart — Login with Valyd
description: 'Add Login with Valyd to a Next.js App Router app: two route handlers with @valyd/sdk server-side and the OIDC transaction in an httpOnly cookie.'
---
