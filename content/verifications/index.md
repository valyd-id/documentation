...
## Agent Quick-Start
- Source URL: https://docs.valyd.work/verifications
...
To choose between them, see https://docs.valyd.work/verifications/modes (modes.md).
