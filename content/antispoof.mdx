...
Start a session, allow the camera in the tab that opens, and follow the prompts. Valyd runs a passive-liveness / presentation-attack check and tells you whether it's a real, live person.
