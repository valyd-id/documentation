...
// server.js — Node 18+ (Express). Install: npm i express @valyd/sdk@^1.10.5
...
- [Liveness API](/verifications/standalone/antispoof) · [Uniqueness API](/verifications/standalone/face-uniqueness)
